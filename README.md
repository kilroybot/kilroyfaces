<h1 align="center">kilroyfaces</h1>
...
For more info about the package itself see `kilroyfaces/README.md`
or [docs](https://kilroybot.github.io/kilroyfaces).
...
write the tests and put them in `kilroyfaces/tests`.
...
Docs should be placed in `kilroyfaces/docs/docs`. They are pretty
